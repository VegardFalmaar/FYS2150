...
partial_E_a1 = -1/(a2 - b2);
partial_E_a2 = -(b1 - a1)/(a2 - b2)^2;
partial_E_b1 = 1/(a2 - b2);
partial_E_b2 = (b1 - a1)/(a2 - b2)^2;

s_E = E*sqrt((partial_E_a1*s_a1)^2 + (partial_E_a2*s_a2)^2 + (partial_E_b1*s_b1)^2 + (partial_E_b2*s_b2)^2)
